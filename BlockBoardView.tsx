...
export const BlockBoardView: React.FC<BlockBoardViewProps> = ({
  ...
  return (
    <div className="relative w-full max-w-[390px] mx-auto select-none">
      {/* Outer Gaming Frame with Midnight Navy and subtle Indigo outline */}
      <div className="relative bg-[#090e23] p-2 rounded-2xl border-2 border-[#1c2754] shadow-2xl shadow-black/80">
        ...
        <div
          ...
          className="grid grid-cols-10 gap-1 aspect-square w-full bg-[#050816] p-1.5 rounded-xl border border-[#141d40] touch-none relative overflow-hidden"
